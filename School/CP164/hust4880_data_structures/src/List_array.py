...
class List: 
    ...
    def combine(self, source1, source2):
        ...
        while(not source1.is_empty() or not source2.is_empty()):
            if(i%2 == 0 and not source1.is_empty()):
                new_list.append(source1.pop(0))
            elif(i%2 != 0 and not source2.is_empty()):
                new_list.append(source2.pop(0))
            i += 1
    ...
    def find(self, key):
        ...
        -------------------------------------------------------
        """
        if(self._linear_search(key) != -1 and len(self._values) > 0):
    ...
    def intersection(self, source1, source2):
        ...
        new_list = []
        for i in source1:
            if(i not in new_list and source2._linear_search(i) != -1):
                new_list.append(i)
        self._values = new_list
    ...
    def is_identical(self, target):
        ...
        if(len(self._values) != len(target)):
            ...
            n = len(self._values)
            i = 0
            while i < n and self._values[i] == target[i]:
                i += 1
            if(i == n):
                identical = True
            else:
    ...
    def remove(self, key):
        ...
        -------------------------------------------------------
        """
        if(len(self._values) <= 0 or key not in self._values):
            value = None
        else:   
            value = self._values.pop(self._linear_search(key))
    ...
    def remove_many(self, key):
        ...
        while(key in self._values):
            self._values.pop(self._linear_search(key))
        return
