...
class Sorted_List:
    ...
    def __contains__(self, key):
        ...
        return -1 != self._binary_search(key)
    ...
    def _binary_search(self, key):
        ...
        if(key not in self._values):
            ...
            if(key == temp_list._values[middle]):
                i += middle
            
            elif(key > temp_list._values[middle]):
                temp_list._values = temp_list._values[middle:]
                i += middle
                i += temp_list._binary_search(key)
    ...
    def insert(self, value):
        ...
        if(len(self._values) <= 0):
            ...
            self._values.insert(len(self._values), value)
        else:
            while(not inserted):
    ...
    def intersection(self, source1, source2):
        ...
        new_list = []
        for i in source1:
            if(i not in new_list and source2._binary_search(i) != -1):
                new_list.append(i)
    ...
    def remove(self, key):
        ...
        """
        value = None
        if(len(self._values) > 0 and key in self._values):
