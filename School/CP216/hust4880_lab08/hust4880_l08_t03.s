...
LDR   R3,  =second
LDRB   R3, [R3]
STMFD  SP!, {R3}   // Push first value of second onto stack
LDR   R3, =first
LDRB   R3, [R3]
STMFD  SP!, {R3}   // Push first value of second onto stack
MOV    R3, #SIZE
...
LDR    R3, =common
STMFD  SP!, {R3}	// Push address of common onto stack
LDR    R3, =second
STMFD  SP!, {R3}	// Push address of second onto stack
LDR    R3, =first
STMFD  SP!, {R3}	// Push address of first onto stack

BL     FindCommon

// clean up the stack
ADD    SP, SP, #24       // Release the parameter memory from stack
