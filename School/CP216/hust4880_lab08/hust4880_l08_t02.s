...
// your code here
LDR    R3, =_Data
STMFD  SP!, {R3}         // Push the end address of the list
LDR    R3, =Max
STMFD  SP!, {R3}         // Push the address of the Max result
LDR    R3, =Min
STMFD  SP!, {R3}         // Push the adddress of the Min result
LDR    R3, =Data   
STMFD  SP!, {R3}         // Push the start address of the list
